...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12  text-center" style="position:relative;min-height:650px;">
                ...
                <img src="/images/smartmockups_jqxetqxn.png" class="img-second-left">
                <img src="/images/smartmockups_jqxetqxn.png" class="img-first">
                <img src="/images/smartmockups_jqxetqxn.png" class="img-second-right">
    ...
    <div class="container text-center" style="background: #f8f9fa;border-radius:10px;padding-top:100px;padding-bottom: 100px;">

        <h1 class="display-4" style="font-weight: lighter;margin-bottom:30px;"> Как это работает </h1>

        <h2 style="font-family: 'Neucha', cursive;">

            Пейджер это бесплатный инструмент для оптимизации трафика в Instagram. <br>

            Вы получаете одну ссылку для управления всем контентом на одной странице. <br>

            Это очень просто, а главное очень полезно.
     ...
     <div class="container text-center" style="padding-top:100px;padding-bottom: 100px;">
        ...
        <p class="mb-0">Что лучше? Потратить 5 минут на ленту Вконтакте или запустить свою страницу в пейджере? Конечно, второе!</p>

        <footer class="blockquote-footer">Ни один пользователь <cite title="Source Title">пейджера</cite></footer>
        </blockquote>
